  ...
  return (
    <footer className="relative bottom-0 left-0 w-full bg-white text-orange-600 py-4 rounded-t-lg shadow-md">
      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div>
          <p>
            <a href="#" onClick={togglePrivacyPolicy} className="mr-4 hover:text-orange-800 transition duration-300 ease-in-out">Privacy Policy</a>
            <a href="#" onClick={toggleTermsConditions} className="hover:text-orange-800 transition duration-300 ease-in-out">Terms and Conditions</a>
          </p>
        </div>
      </div>
